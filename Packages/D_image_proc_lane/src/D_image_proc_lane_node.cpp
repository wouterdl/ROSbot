...
int main(int argc, char **argv)
{
  ...
  //Initializing Node
	ros::init(argc, argv, "image_proc_lane_D");
	ros::NodeHandle n;
	Lanes lanes;
	...
	ros::Publisher Hough_pub = n.advertise<std_msgs::Int64MultiArray>("Hough_D", 0);


	//Subscriber
	image_transport::ImageTransport it(n);
	image_transport::Subscriber sub;
	sub = it.subscribe("/camera_D/rgb/image_raw", 1, &Lanes::imagecallback, &lanes);

	image_transport::Publisher imgpub = it.advertise("edge_img_D", 1);
