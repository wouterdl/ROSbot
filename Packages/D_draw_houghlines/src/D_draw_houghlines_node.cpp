...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "D_draw_houghlines");
  ros::NodeHandle n;
  Linedata linedata;
  Imagedata imagedata;
  ...
  imgsub = it.subscribe("/camera_D/rgb/image_raw", 1, &Imagedata::imagecallback, &imagedata);

  //Subscrbing to Hough lines topic
  ros::Subscriber linesub = n.subscribe("Hough_D", 10, &Linedata::linescallback, &linedata);
  image_transport::Publisher imgpub = it.advertise("image_lines_D", 1);
